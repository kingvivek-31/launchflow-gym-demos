...
// Dark Theme: #0A0A0A background, #E53935 teal accent, #FFFFFF text
document.getElementById('sections-placeholder').innerHTML = `

<!-- ============================================================
     SECTION 6: CLASSES
============================================================ -->
<section id="classes" class="py-40 section-dark border-t-4 border-[#E53935]" style="position:relative;overflow:hidden;">
  <div class="max-w-7xl mx-auto px-6" style="position:relative;z-index:1;">
    <div class="text-center mb-16 fade-up">
      <div class="flex items-center justify-center gap-3 mb-6">
        <div class="w-8 h-px bg-[#E53935]"></div>
        <span class="text-[#E53935] font-condensed font-700 uppercase tracking-[0.3em] text-sm">What We Offer</span>
        <div class="w-8 h-px bg-[#E53935]"></div>
      </div>
      <h2 class="font-condensed font-black uppercase text-5xl lg:text-7xl leading-none text-white mb-4">CLASSES FOR EVERY <span class="text-[#E53935]">ATHLETE</span></h2>
    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      ${[
    { name: 'Powerlifting', img: 'https://images.unsplash.com/photo-1584466977773-e625c37cdd50?w=600&auto=format&fit=crop&q=80', duration: '60 min', level: 'Advanced', levelColor: 'bg-[#E53935] text-black', trainer: 'Vikram Singh' },
    ...
    { name: 'CrossFit', img: 'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=600&auto=format&fit=crop&q=80', duration: '60 min', level: 'Advanced', levelColor: 'bg-[#E53935] text-black', trainer: 'Rahul Verma' },
  ].map(c => `
        <div class="class-card card-left-accent group overflow-hidden fade-up">
          <div class="relative h-52 overflow-hidden">
            <img src="${c.img}" alt="${c.name} class at Club Viva" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500 filter brightness-75" loading="lazy"/>
          ...
          <div class="p-6">
            ...
            <div class="flex items-center gap-3 mb-4">
              ...
              <span class="text-[#E53935]/40">·</span>
              <span class="text-white/40 text-xs">with ${c.trainer}</span>
            </div>
            <a href="#booking" class="inline-block w-full text-center py-2.5 bg-transparent border border-[#E53935]/40 text-[#E53935] font-condensed uppercase tracking-widest text-xs hover:bg-[#E53935] hover:text-black transition-all duration-200">Book Now</a>
          </div>
        </div>
      `).join('')}
...
<!-- ============================================================
     SECTION 7: TRAINERS
============================================================ -->
<section id="trainers" class="py-40 section-light border-y-4 border-black" style="position:relative;overflow:hidden;">
  <div class="max-w-7xl mx-auto px-6" style="position:relative;z-index:1;">
    <div class="text-center mb-16 fade-up">
      <div class="flex items-center justify-center gap-3 mb-6">
        <div class="w-8 h-px bg-[#E53935]"></div>
        <span class="text-[#E53935] font-condensed font-700 uppercase tracking-[0.3em] text-sm">The Team</span>
        <div class="w-8 h-px bg-[#E53935]"></div>
      </div>
      <h2 class="font-condensed font-black uppercase text-5xl lg:text-7xl leading-none text-black mb-4">MEET OUR <span class="text-[#E53935]">EXPERT TRAINERS</span></h2>
      <p class="text-black/60 text-base max-w-lg mx-auto">World-class coaches dedicated entirely to your transformation.</p>
    </div>
    ...
    { name: 'Karan Thakur', title: 'Combat & Boxing Coach', spec: 'Boxing · MMA · Kickboxing', img: 'https://images.unsplash.com/photo-1583454110551-21f2fa2afe61?w=500&auto=format&fit=crop&q=80' },
        ...
        <div class="trainer-card card-left-accent group overflow-hidden fade-up relative">
          <div class="relative h-72 overflow-hidden">
            <img src="${t.img}" alt="${t.name} — trainer at Club Viva" class="w-full h-full object-cover object-top group-hover:scale-105 transition-transform duration-500 filter brightness-75" loading="lazy"/>
            <div class="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent"></div>
            <!-- Hover overlay -->
            <div class="trainer-overlay absolute inset-0 flex items-center justify-center">
              <a href="#booking" class="px-6 py-3 bg-black border-2 border-[#E53935] text-[#E53935] font-condensed font-black uppercase tracking-widest text-sm hover:bg-[#E53935] hover:text-black transition-all">View Profile</a>
            </div>
          </div>
          <div class="p-6">
            <h3 class="font-condensed font-black uppercase text-xl text-white mb-1">${t.name}</h3>
            <p class="text-[#E53935] text-xs font-condensed uppercase tracking-widest mb-3">${t.title}</p>
            <p class="text-white/40 text-xs leading-relaxed">${t.spec}</p>
            <div class="flex gap-3 mt-4">
              <a href="#" class="text-white/30 hover:text-[#E53935] transition-colors">
...
============================================================ -->
<section id="membership" class="py-40 section-dark border-t-4 border-[#E53935]" style="position:relative;overflow:hidden;">
  <div class="max-w-7xl mx-auto px-6" style="position:relative;z-index:1;">
    <div class="text-center mb-16 fade-up">
      <div class="flex items-center justify-center gap-3 mb-6">
        <div class="w-8 h-px bg-[#E53935]"></div>
        <span class="text-[#E53935] font-condensed font-700 uppercase tracking-[0.3em] text-sm">Plans & Pricing</span>
        <div class="w-8 h-px bg-[#E53935]"></div>
      </div>
      <h2 class="font-condensed font-black uppercase text-5xl lg:text-7xl leading-none text-white mb-4">CHOOSE YOUR <span class="text-[#E53935]">PATH</span></h2>
    ...
    <div class="grid lg:grid-cols-3 gap-6 items-center">
      ...
      <div class="membership-card p-8 fade-up">
        ...
        <ul class="space-y-3 mb-8">
          ...
          <li class="flex items-start gap-3 text-sm text-white/50">
            <svg class="w-4 h-4 text-[#E53935] mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path d="M16.707 5.293a1 1 0 00-1.414 0L8 12.586 4.707 9.293a1 1 0 00-1.414 1.414l4 4a1 1 0 001.414 0l8-8a1 1 0 000-1.414z"/></svg>
            ${f}
          </li>`).join('')}
        </ul>
        <a href="#booking" class="block text-center py-3 border border-[#E53935]/40 text-[#E53935] font-condensed uppercase tracking-widest text-sm hover:bg-[#E53935] hover:text-black transition-all duration-200">Get Started</a>
      </div>

      <!-- Elite (highlighted) -->
      <div class="membership-card featured p-8 fade-up delay-100 relative -mt-4 -mb-4 lg:-mt-6 lg:-mb-6">
        <div class="absolute -top-4 left-1/2 -translate-x-1/2">
          <span class="px-5 py-1.5 bg-[#E53935] text-black font-condensed font-black uppercase tracking-widest text-xs whitespace-nowrap">Most Popular</span>
        </div>
        <p class="text-[#E53935] font-condensed uppercase tracking-widest text-xs mb-4 mt-4">Pro Athlete</p>
        <div class="mb-8">
        ...
        <a href="#booking" class="block text-center py-3 bg-[#E53935] text-black font-condensed font-black uppercase tracking-widest text-sm hover:bg-[#17a39c] transition-all duration-200">Join Now</a>
      </div>
      ...
      <div class="membership-card p-8 fade-up delay-200">
        ...
        <a href="#booking" class="block text-center py-3 border border-[#E53935]/40 text-[#E53935] font-condensed uppercase tracking-widest text-sm hover:bg-[#E53935] hover:text-black transition-all duration-200">Go Elite</a>
      </div>

    </div>
    <p class="text-center text-white/30 text-sm mt-10 fade-up">✦ Annual plans available — save up to 20% · No joining fee this month · <a href="#" class="text-[#E53935] hover:underline">View Annual Plans →</a></p>
  </div>
</section>
...
============================================================ -->
<section id="testimonials" class="py-40 section-dark overflow-hidden border-t-4 border-[#111]" style="position:relative;">
  <div class="max-w-7xl mx-auto px-6 text-center mb-16 fade-up" style="position:relative;z-index:1;">
    <div class="flex items-center justify-center gap-3 mb-6">
      <div class="w-8 h-px bg-[#E53935]"></div>
      <span class="text-[#E53935] font-condensed font-700 uppercase tracking-[0.3em] text-sm">Success Stories</span>
      <div class="w-8 h-px bg-[#E53935]"></div>
    </div>
      <h2 class="font-condensed font-black uppercase text-5xl lg:text-7xl leading-none text-white">REAL RESULTS. <span class="text-[#E53935]">REAL PEOPLE.</span></h2>
  </div>
  ...
  <div class="testimonial-track mb-4">
    ...
    { q: 'Zumba classes are so fun! I actually look forward to working out now.', name: 'Meera P.', plan: 'Starter Member' },
        ...
        <div class="testimonial-card flex-shrink-0 w-80 p-6">
          <div class="flex gap-1 mb-4">${'★'.repeat(5).split('').map(() => '<span class="text-[#E53935] text-sm">★</span>').join('')}</div>
          <p class="text-white/60 text-sm leading-relaxed mb-5 italic">"${t.q}"</p>
          <div class="flex items-center gap-3">
            <div class="w-8 h-8 rounded-full bg-[#E53935]/20 border border-[#E53935]/40 flex items-center justify-center text-[#E53935] text-xs font-condensed font-black">${t.name[0]}</div>
            <div>
              <p class="text-white font-condensed font-700 text-sm">${t.name}</p>
              <span class="text-xs px-2 py-0.5 bg-[#E53935]/10 text-[#E53935] font-condensed uppercase tracking-wider">${t.plan}</span>
            </div>
          </div>
        </div>
      `).join('')}
...
<!-- ============================================================
     SECTION 10: EVENTS
============================================================ -->
<section id="events" class="py-40 section-light border-y-4 border-black" style="position:relative;overflow:hidden;">
  <div class="max-w-7xl mx-auto px-6" style="position:relative;z-index:1;">
    <div class="text-center mb-16 fade-up">
      <div class="flex items-center justify-center gap-3 mb-6">
        <div class="w-8 h-px bg-[#E53935]"></div>
        <span class="text-[#E53935] font-condensed font-700 uppercase tracking-[0.3em] text-sm">Upcoming Events</span>
        <div class="w-8 h-px bg-[#E53935]"></div>
      </div>
      <h2 class="font-condensed font-black uppercase text-5xl lg:text-7xl leading-none text-black">CHALLENGES. <span class="text-[#E53935]">WORKSHOPS.</span> MEETUPS.</h2>
    </div>
    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
      ${[
    ...
    { title: 'Nutrition Workshop', img: 'https://images.unsplash.com/photo-1490645935967-10de6ba17061?w=600&auto=format&fit=crop&q=80', date: 'March 22, 2025', loc: 'Nutrition Bar', note: 'Free with registration' },
        ...
        <div class="blog-card card-left-accent group overflow-hidden fade-up">
          ...
          <div class="p-6">
            <p class="text-[#E53935] font-condensed uppercase tracking-widest text-xs mb-2">${e.date}</p>
            ...
            <a href="#booking" class="inline-block px-5 py-2 bg-[#E53935] text-black font-condensed font-black uppercase tracking-widest text-xs hover:bg-[#17a39c] transition-all">Register Now</a>
          </div>
        </div>
      `).join('')}
    </div>
...
============================================================ -->
<section id="app" class="py-40 section-dark relative overflow-hidden border-y-4 border-[#111]">
  <div class="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center relative" style="z-index:1;">
    <div class="fade-up">
      <div class="flex items-center gap-3 mb-6">
        <div class="w-8 h-px bg-[#E53935]"></div>
        <span class="text-[#E53935] font-condensed font-700 uppercase tracking-[0.3em] text-sm">Club Viva App</span>
      </div>
      <h2 class="font-condensed font-black uppercase text-5xl lg:text-7xl leading-none text-white mb-6">TRAIN ANYTIME.<br/><span class="text-[#E53935]">BOOK ANYWHERE.</span></h2>
      ...
      <ul class="space-y-3 mb-10">
        ...
        <li class="flex items-center gap-3 text-sm text-white/60">
          <div class="w-1.5 h-1.5 rounded-full bg-[#E53935] flex-shrink-0"></div>
          ${f}
        </li>`).join('')}
      </ul>
    ...
    <div class="fade-up delay-200 flex justify-center">
      <div class="relative w-64">
        <div class="bg-[#0A0A0F] border-4 border-[#E53935]/20 rounded-[2.5rem] overflow-hidden shadow-2xl shadow-[#E53935]/5">
          <div class="px-4 py-6">
            <div class="flex items-center justify-between mb-6">
              ...
              <div class="w-9 h-9 rounded-full bg-[#E53935]/20 border border-[#E53935]/40"></div>
            </div>
            <div class="bg-[#E53935]/10 border border-[#E53935]/20 p-3 rounded mb-4">
              <p class="text-[#E53935] text-xs font-condensed uppercase tracking-wider mb-1">Next Session</p>
            ...
            <div class="flex items-center justify-between py-2 border-b border-[#E53935]/10">
              <div>
                <p class="text-white text-xs font-condensed">${c}</p>
                <p class="text-white/30 text-xs">${['Mon · 6PM', 'Wed · 8AM', 'Fri · 5PM'][i]}</p>
              </div>
              <button class="px-3 py-1 bg-[#E53935]/15 text-[#E53935] text-xs font-condensed">Book</button>
            </div>`).join('')}
          </div>
        </div>
      </div>
...
<!-- ============================================================
     SECTION 12: BLOG
============================================================ -->
<section id="blog" class="py-40 section-light border-y-4 border-black" style="position:relative;overflow:hidden;">
  <div class="max-w-7xl mx-auto px-6" style="position:relative;z-index:1;">
    <div class="flex items-end justify-between mb-16 fade-up flex-wrap gap-4">
      <div>
        <div class="flex items-center gap-3 mb-4">
          <div class="w-8 h-px bg-[#E53935]"></div>
          <span class="text-[#E53935] font-condensed font-700 uppercase tracking-[0.3em] text-sm">From the Blog</span>
        </div>
        <h2 class="font-condensed font-black uppercase text-5xl lg:text-7xl leading-none text-black">FITNESS TIPS &amp; <span class="text-[#E53935]">INSIGHTS</span></h2>
      </div>
      <a href="#" class="text-[#E53935] font-condensed uppercase tracking-widest text-xs hover:underline">View All Posts →</a>
    </div>
    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
      ${[
    { img: 'https://images.unsplash.com/photo-1526506118085-60ce8714f8c5?w=600&auto=format&fit=crop&q=80', cat: 'Training', catColor: 'bg-[#E53935]/20 text-[#E53935]', title: '5 Exercises for Explosive Strength', excerpt: 'These compound movements form the foundation of every elite strength program at Club Viva.' },
    ...
    { img: 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=600&auto=format&fit=crop&q=80', cat: 'Recovery', catColor: 'bg-purple-600/20 text-purple-400', title: 'How to Use the Sauna for Faster Recovery', excerpt: 'Heat exposure post-training can dramatically improve muscle recovery. Here\'s the Club Viva protocol.' },
        ...
        <div class="blog-card card-left-accent group overflow-hidden fade-up">
          ...
          <div class="p-6">
            ...
            <a href="#" class="text-[#E53935] font-condensed uppercase tracking-widest text-xs hover:underline">Read More →</a>
          </div>
        </div>
      `).join('')}
    </div>
...
============================================================ -->
<section class="cta-section relative py-40 overflow-hidden text-center bg-[#E53935] border-y-4 border-black text-black">
  <div class="relative max-w-4xl mx-auto px-6 fade-up">
    <div class="flex items-center justify-center gap-3 mb-6">
      <div class="w-8 h-px bg-black"></div>
      <span class="text-black font-condensed font-700 uppercase tracking-[0.3em] text-sm">Limited Time Offer</span>
      <div class="w-8 h-px bg-black"></div>
    </div>
    <h2 class="font-condensed font-black uppercase text-7xl lg:text-8xl xl:text-[8rem] leading-none text-black mb-6">START YOUR<br/><span class="text-white">TRANSFORMATION.</span></h2>
    <p class="text-black/70 text-xl font-bold mb-12 max-w-lg mx-auto">First 7 days are completely on us. No commitment. No credit card required.</p>
    <a href="#booking" class="btn-ghost !border-black !text-black hover:!bg-black hover:!text-white inline-block text-base px-12 py-5">CLAIM FREE TRIAL</a>
    <p class="text-black/50 font-bold text-sm mt-6">Join 3,000+ members already training at Club Viva</p>
  </div>
</section>
...
<!-- ============================================================
     SECTION 14: FOOTER
============================================================ -->
<footer id="footer" class="bg-black border-t-4 border-[#E53935]">
  <div class="max-w-7xl mx-auto px-6 py-20 grid sm:grid-cols-2 lg:grid-cols-4 gap-12">
    ...
    <div>
      <div class="flex flex-col items-start hover:scale-105 transition-transform duration-300 mb-5">
          <div class="flex items-center gap-2">
            <svg class="w-8 h-8 text-[#E53935]" viewBox="0 0 24 24" fill="currentColor">
              <path d="M17,8C8,10 5.9,16.17 3.82,21.34L5.71,22l1-2.3A4.49,4.49,0,0,0,8,20C19,20 22,3 22,3,21,5 14,5.25 17,8Z" />
            </svg>
            <div class="flex flex-col items-start leading-none">
              <span class="font-condensed font-black text-2xl md:text-3xl tracking-[0.1em] text-white">CLUB VIVA</span>
              <span class="font-condensed font-bold text-[10px] md:text-[12px] uppercase tracking-[0.5em] text-[#888] mt-1 text-center w-full">EST. 2025</span>
            </div>
          </div>
      </div>
      ...
      <div class="flex gap-4">
        <a href="#" class="w-8 h-8 bg-[#E53935]/10 border border-[#E53935]/20 flex items-center justify-center text-white/40 hover:text-[#E53935] hover:border-[#E53935]/50 transition-all">
          <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/></svg>
        </a>
        <a href="#" class="w-8 h-8 bg-[#E53935]/10 border border-[#E53935]/20 flex items-center justify-center text-white/40 hover:text-[#E53935] hover:border-[#E53935]/50 transition-all">
        ...
        <a href="https://wa.me/918920306202" target="_blank" class="w-8 h-8 bg-[#E53935]/10 border border-[#E53935]/20 flex items-center justify-center text-white/40 hover:text-[#E53935] hover:border-[#E53935]/50 transition-all">
    ...
    <!-- Col 2 -->
    <div>
      <h4 class="font-condensed font-black uppercase tracking-widest text-sm text-[#E53935] mb-6">Quick Links</h4>
      <ul class="space-y-3">
        ${['Home', 'About', 'Facilities', 'Classes', 'Trainers', 'Membership', 'Blog'].map(l => `
        <li><a href="#${l.toLowerCase()}" class="text-white/40 text-sm hover:text-[#E53935] transition-colors">${l}</a></li>
        `).join('')}
      </ul>
    </div>
    <!-- Col 3 -->
    <div>
      <h4 class="font-condensed font-black uppercase tracking-widest text-sm text-[#E53935] mb-6">Support</h4>
      <ul class="space-y-3">
        ${['FAQs', 'Book a Tour', 'Contact Us', 'Refund Policy', 'Privacy Policy', 'Terms of Service'].map(l => `
        <li><a href="#" class="text-white/40 text-sm hover:text-[#E53935] transition-colors">${l}</a></li>
        `).join('')}
      </ul>
    </div>
    <!-- Col 4 -->
    <div>
      <h4 class="font-condensed font-black uppercase tracking-widest text-sm text-[#E53935] mb-6">Get In Touch</h4>
      <ul class="space-y-4 text-sm text-white/40">
        <li class="flex items-start gap-3">
          <svg class="w-4 h-4 text-[#E53935] mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
          Rohini Sector 24, New Delhi — 110085
        </li>
        <li class="flex items-start gap-3">
          <svg class="w-4 h-4 text-[#E53935] mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
        ...
        <li class="flex items-start gap-3">
          <svg class="w-4 h-4 text-[#E53935] mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
          hello@clubviva.in
        </li>
      </ul>
    </div>
  ...
  <!-- Bottom bar -->
  <div class="border-t border-[#E53935]/10">
    <div class="max-w-7xl mx-auto px-6 py-5 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-white/30">
      <p>© 2025 Club Viva. All rights reserved.</p>
      <div class="flex gap-5">
        <a href="#" class="hover:text-[#E53935] transition-colors">Privacy Policy</a>
        <a href="#" class="hover:text-[#E53935] transition-colors">Terms of Service</a>
      </div>
    </div>
  </div>
</footer>
